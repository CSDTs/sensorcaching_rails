...
class SensorDataControllerTest < ActionController::TestCase
  ...
  test "should create sensor_datum" do
    assert_difference('SensorDatum.count') do
      post :create, sensor_datum: { data: @sensor_datum.data, date: @sensor_datum.date, sensor_id: @sensor_datum.sensor_id }
    end
  ...
  test "should update sensor_datum" do
    patch :update, id: @sensor_datum, sensor_datum: { data: @sensor_datum.data, date: @sensor_datum.date, sensor_id: @sensor_datum.sensor_id }
    assert_redirected_to sensor_datum_path(assigns(:sensor_datum))
  end
